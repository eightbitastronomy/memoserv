...
where B: BackCopy 
{
    ...
    fn check(&self) -> bool;
    fn erase(&self, targ: Option<B>); //needed internally
    ...
    fn least_recent(&self) -> Option<B>; 
    fn make(&mut self, src: &str, aux: &[&str]) -> Result<(), MBError>;
    fn most_recent(&self) -> Option<B>;
    fn pop_least_recent(&mut self) -> Option<B>; 
    fn pop_most_recent(&mut self) -> Option<B>; 
    fn push(&mut self, item: B); 
